...
<body>
		...
		<div class="container">
			<div class="row">
				<div class="blog-post featured-post">
					<img src="img/blog/home.jpg" alt="">
					<h3>Purchase your favorite games in a blink of an eye!</h3>
					<div class="post-metas">
						<div class="post-meta">Welcome to GamingNexus!</div>
					</div>
					<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
						incididunt ut labore et dolore magna aliqua. Quis ipsum suspendisse ultrices gravida.
						Risus commodo viverra maecenas accumsan lacus vel facilisis. Fusce urna quam, euismod
						sit amet mollis quis, vestibulum quis velit. Morbi id dictum quam, ut commodo lorem.
						In at nisi nec arcu porttitor aliquet vitae at dui.</p>
					<p id="containerData"></p>
					<a id="btn" class="site-btn">Read More</a>
				</div>
			</div>
		</div>
	</section>
	...
	<script src="js/fetchDesc.js"></script>
